...
//	newbesttime, the value, if any, of the new best time recorded
//		(negative values indicate levels with no time limit and the
//		absolute value would then indicate actual num of seconds taken)
